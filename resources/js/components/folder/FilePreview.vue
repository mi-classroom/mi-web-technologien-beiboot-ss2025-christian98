...
<template>
    <div
        ...
        <img :src="src" alt="" class="pointer-events-none object-cover group-hover:opacity-75"/>
    ...
    <p class="pointer-events-none block text-sm font-medium text-gray-500">{{ file.file.size }}</p>
</template>
