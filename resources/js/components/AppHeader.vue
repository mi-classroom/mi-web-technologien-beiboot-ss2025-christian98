...
const currentMainNavTrigger = ref('');
                    ...
                    <NavigationMenu class="ml-10 flex h-full items-stretch" v-model="currentMainNavTrigger"
                        ...
                        <NavigationMenuList class="flex h-full items-stretch space-x-2">
                            <NavigationMenuItem v-for="(item, index) in mainNavItems" :key="index"
                                ...
                                <template v-if="'items' in item && item.items.length > 0">
                                    <NavigationMenuTrigger class="flex flex-row cursor-pointer px-3">
                                    ...
                                    <NavigationMenuContent>
                                        <NavigationMenuSub default-value="overview">
                                            <NavigationMenuList class="flex flex-col items-start">
                                                ...
                                                <NavigationMenuItem v-for="subItem in item.items" :key="subItem.title"
                                                                    class="relative w-full">
                                                    <NavigationMenuLink as-child
                                ...
                                >
                                    <Link class="flex flex-row" :href="item.href" :disabled="item.disabled">
                                        <component v-if="item.icon" :is="item.icon" class="mr-2 h-4 w-4"/>
                                        {{ item.title }}
                                    </Link>
                                </NavigationMenuLink>
