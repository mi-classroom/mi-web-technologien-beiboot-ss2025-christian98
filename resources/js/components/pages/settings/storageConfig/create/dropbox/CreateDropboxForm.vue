...
<template>
    <span>
    Creating a new Dropbox connection is not fully supported, because we would need to implement OAuth2 flow.
    The provider backend is functional and could be used by retrieving a token manually.
    </span>
    <div>
        You can create a new App and generate an Access Token here:
        <a href="https://www.dropbox.com/developers/apps" target="_blank" class="text-blue-600 underline">https://www.dropbox.com/developers/apps</a>
        . Make sure to select "Full Dropbox" access. Give the following permissions to the app:
    ...
    <div>
        ...
        <Input id="access_token" name="access_token" type="text" v-model="form.provider_options.access_token"/>
