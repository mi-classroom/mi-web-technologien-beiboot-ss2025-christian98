...
<template>
    <Dialog>
        <DialogTrigger as-child>
            <button
                class="text-gray-400 transition-colors hover:text-gray-600 dark:text-gray-300 dark:hover:text-gray-400"
                title="View details">
                <svg
                    class="h-5 w-5"
                    fill="none"
        ...
        <DialogContent>
            ...
            <div v-if="definition" class="space-y-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-900 dark:text-gray-50">
                        <code
                            class="rounded bg-gray-100 px-2 py-1 dark:bg-gray-600">
                            {{ definition.tag }}
                        </code>
                    </p>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-900 dark:text-gray-50">
                            {{ definition.spec.min_length }} -
                            {{ definition.spec.max_length }}
                        </p>
                    </div>
                </div>
                ...
                <div
                    v-if="
                        definition.spec.enum_values &&
                        definition.spec.enum_values.length > 0
                    ">
                    <label
                        class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                        Enum Values
