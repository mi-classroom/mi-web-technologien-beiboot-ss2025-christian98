...
const deleteDefinition = (e: Event) => {
    ...
    form.delete(
        route('settings.iptc-tag-definitions.destroy', {
            iptc_tag_definition: props.definition,
        }),
        {
            preserveScroll: true,
            ...
            <form class="space-y-6" @submit="deleteDefinition">
                <DialogHeader class="space-y-3">
                    <DialogTitle>
                        ...
                        <span class="italic">{{ props.definition.name }}</span
                        >?
                    </DialogTitle>
                    <DialogDescription>
                        Are you sure you want to delete '{{
                            props.definition.name
                        }}'? This action cannot be undone and it will be deleted
                        from all associated files.
                    </DialogDescription>
                </DialogHeader>
